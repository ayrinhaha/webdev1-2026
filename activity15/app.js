...
const renderAssignmentsRows = (list) => {
    if (list.length === 0) {
        return `<tr><td colspan="4" class="no-results">No plots or members match "${searchQuery}"</td></tr>`;
...
const hydrateDashboard = () => {
    ...
    document.getElementById("assignments-body").innerHTML = renderAssignmentsRows(plotAssignments);
